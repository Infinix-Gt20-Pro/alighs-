...
export default function AuthModal() {
  const { isAuthModalOpen, authModalTab, closeAuthModal, openAuthModal, signIn, signUp, signInWithGoogle } = useAuth();
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-white dark:bg-[#1A1A24] border border-[#B88A32]/30 hover:border-[#B88A32] text-[#2A2118] dark:text-[#F5EFE6] font-medium text-xs font-sans tracking-wide shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-50"
            >
              {googleLoading ? (
